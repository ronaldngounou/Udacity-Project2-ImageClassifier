# python predict.py home/workspace/ImageClassifier/flowers/train/1/image_06734.jpg model_20221114_224023.pth --gpu
# python predict.py flowers/train/10/image_07086.jpg model_20221114_224023.pth --gpu --top_k 5
...
model = models.vgg16(pretrained = True) #we see that the out_feature is 1000.

#Froze the paramaters to make sure they don't get updated - Turn off gradients for our model 
...
classifier = nn.Sequential(nn.Linear(25088, 4096),
                     ...
                     nn.Linear(4096, 1024),
                     nn.ReLU(),
                     nn.Dropout(p=0.2), #Adding another dropout layer to prevent further overfitting
                     nn.Linear(1024, 512),
                     nn.ReLU(),
                     nn.Linear(512, 102),
                     nn.Dropout(p=0.2),
...
def process_image(image):
    ...
    np_image_array = (image - means) / stds
