...
classifier = nn.Sequential(nn.Linear(25088, 4096),
 ...
 # Maybe I should build the classifier line 184   
...
def trainClassifier(model, epochs_nb, criterion, optimizer, trainloader, validloader, current_device):
...
# -----------
def saveCheckpoint(model, epochs_nb, train_data, optimizer, savedir=''):
...
def main():
	...
	train_loss, valid_loss, valid_accuracy = trainClassifier(model, 
		epochs_nb, criterion, optimizer, trainloader, validloader, current_device)
	...
	filename = saveCheckpoint(model, epochs_nb, train_data, optimizer, args.save_dir)
